          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Experience lightning-fast speeds, reliable uptime, and exceptional performance metrics that drive your business forward.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Real-time data showcasing our platform's exceptional performance across all key metrics.
              </p>
            </div>
