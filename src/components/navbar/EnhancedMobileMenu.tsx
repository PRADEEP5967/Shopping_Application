...
import { X, Home, ShoppingBag, User, Heart, Search, Gift } from 'lucide-react';
...
const EnhancedMobileMenu: React.FC<EnhancedMobileMenuProps> = ({
  ...
  const mainNavItems = [
    ...
    { name: 'Deals', href: '/deals-discounts', icon: Gift },
  ];
          ...
          {mainNavItems.map((item) => {
            ...
            return (
              <Link
                ...
                to={item.href}
                onClick={closeMenu}
                className="flex items-center gap-3 px-3 py-2.5 text-gray-700 hover:bg-gray-50 hover:text-primary rounded-lg transition-colors group"
              >
          ...
          {quickActions.map((action) => {
            ...
            return (
              <Link
                ...
                to={action.href}
                onClick={closeMenu}
                className="flex items-center justify-between px-3 py-2.5 text-gray-700 hover:bg-gray-50 hover:text-primary rounded-lg transition-colors group"
              >
                <div className="flex items-center gap-3">
                  <Icon className="h-5 w-5 text-gray-400 group-hover:text-primary" />
